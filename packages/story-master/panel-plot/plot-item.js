...
module.exports = function () {
    Vue.component("plot-item", {
        ...
        directives: {},
        created() {
            this.$root.$on(Msg.PlotItemSelected, function (event, data) {
        ...
        methods: {
            ...
            onPlotItemMenu(event) {
                Editor.Ipc.sendToPanel('story-master.plot', "getCutItemID", function (id, parent) {
                    ...
                    Editor.Ipc.sendToMain('story-master:onPlotItemMenu', event.x, event.y,
                        this.data,
                        options
                    );
                }.bind(this));
